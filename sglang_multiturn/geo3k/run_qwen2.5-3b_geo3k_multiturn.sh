...
python3 -m verl.trainer.main_ppo \
    ...
    actor_rollout_ref.model.path=/mnt/data/ms-swift/qwen3-vl-4b \
    ...
    data.train_files=/mnt/data/verl/datasets/geo3k/geo3k_multiturn_w_tool/train.parquet \
    data.val_files=/mnt/data/verl/datasets/geo3k/geo3k_multiturn_w_tool/test.parquet \
