...
from graph.graph_eval import run_agent

def main():
    # Parse command line arguments
    parser = argparse.ArgumentParser(description='Run math tasks from a JSONL file')
    parser.add_argument('--config', type=str, default='configs/eval.yaml',
                       help='Path to the configuration file (default: configs/eval.yaml)')
    ...
    def run_tasks_from_file(config: Dict[str, Any]):
        ...
        processed_ids = get_processed_ids(config["logging"]["eval_file_path"])
